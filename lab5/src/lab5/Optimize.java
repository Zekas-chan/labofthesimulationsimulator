...
//	StartEvent startEvent;
	...
	public MarketState metod1(int registers, int FRÖ) {
		...
		MarketState marketState = new MarketState(simtid, kassor, lambda, frö, maxkunder, plocktid, betaltid,
				eventQueue);
	...
	/**
	 * Kör flera simuleringar med fixerat frö men varierande mängd kassor tills
	 * optimal mängd kassor hittats.
	 */
	public int metod2(int FRÖ) {
		/*
		 * Logiken är inte optimal eller testad än. Tanken är att köra på en
		 * ineffektivare metod för att få fram funktionaliteten först och sedan
		 * optimera.
		 */
		int missadeKunder = 0;
		int kassor = 1;
		int missadeFörraKörning = metod1(kassor, FRÖ).antalMissadeKunder; // etablerar en baseline med minimal mängd
																			// kassor; optimeras sedan för att missa så
																			// få kunder som möjligt.
